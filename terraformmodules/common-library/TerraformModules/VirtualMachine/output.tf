# #############################################################################
# # OUTPUTS Linux VM and Windows VM
# #############################################################################
...
output "windows_vm_private_ip_address" {
  value = [for x in azurerm_windows_virtual_machine.windows_vms : x.private_ip_address]
}

output "windows_vm_public_ip_address" {
  value = [for x in azurerm_windows_virtual_machine.windows_vms : x.public_ip_address]
}
